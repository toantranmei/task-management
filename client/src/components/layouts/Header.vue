    ...
    <header class="topbar">
        <nav class="navbar top-navbar navbar-expand-md navbar-dark">
            <div class="navbar-header">
                ...
                <a class="nav-toggler waves-effect waves-light d-md-none" href="javascript:void(0)">
                ...
                <a class="navbar-brand" href="index.html">
                    ...
                    <b class="logo-icon">
                        ...
                        <!-- Dark Logo icon -->
                        <img :src="images.darklogo" alt="homepage" class="dark-logo" />
                        <!-- Light Logo icon -->
                        <img :src="images.lightlogo" alt="homepage" class="light-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text">
                        <!-- dark Logo text -->
                        <img :src="images.darktext" alt="homepage" class="dark-logo" />
                        <!-- Light Logo text -->
                        <img :src="images.lighttext" class="light-logo" alt="homepage" />
                    </span>
                </a>
                <!-- ============================================================== -->
                <!-- End Logo -->
                ...
                <!-- ============================================================== -->
                <a class="topbartoggler d-md-none waves-effect waves-light" href="javascript:void(0)" data-toggle="collapse" data-target="#navbarSupportedContent"
                ...
                <ul class="navbar-nav float-right">
                            ...
                            <ul class="list-style-none">
                                ...
                                <li>
                                    <div class="message-center message-body">
                                        ...
                                        <a href="javascript:void(0)" class="message-item">
                                            <span class="user-img">
                                                <img :src="images.userImage" alt="user" class="rounded-circle">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img :src="images.userImage" alt="user" class="rounded-circle" width="31">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            ...
                            <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                <div class="">
                                    <img :src="images.userImage" alt="user" class="img-circle" width="60">
                                </div>
                                <div class="m-l-10">
