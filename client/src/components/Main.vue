    ...
    <div class="container-fluid">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <h4 class="card-title">Số lượng công việc hoàn thành</h4>
                                <h5 class="card-subtitle">Biểu đổ so sánh hai tuần gần nhất</h5>
                            </div>
                            <div class="ml-auto">
                                <ul class="list-inline font-12 dl m-r-10">
                                    <li class="list-inline-item">
                                        <i class="fas fa-dot-circle text-info"></i> Trần 1
                                    </li>
                                    <li class="list-inline-item">
                                        <i class="fas fa-dot-circle text-danger"></i> Tuần 2</li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="m-l-10">
                                <h4 class="m-b-0">Số lượng dự án tham gia theo ngày</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card bg-light-info no-card-border">
                            <div class="card-body">
                                <h5 class="card-title">Loại dự án</h5>
                                <div class="d-flex no-block">
                                    <div class="align-self-center no-shrink">
                                        <h2 class="m-b-0">314 công việc</h2>
                                        <h6 class="text-muted">Số liệu tính theo tháng</h6>
                                    </div>
                                    <div class="ml-auto">
                    ...
                    <div class="col-md-12">
                        <div class="card bg-light-success no-card-border">
                            <div class="card-body">
                                <h5 class="card-title">Tỉ lệ công việc</h5>
                                <div class="d-flex no-block">
                                    <div class="align-self-end no-shrink">
                                        <h2 class="m-b-0">12/13</h2>
                                        <h6 class="text-muted">Số liệu thống kê theo công việc</h6>
                                    </div>
                                    <div class="ml-auto">
                ...
                <div class="card o-income">
                    <div class="card-body">
                        <div class="d-flex m-b-30 no-block">
                            <h5 class="card-title m-b-0 align-self-center">Biểu đồ dự đoán thói quen</h5>
                            <div class="ml-auto">
                        ...
                        <ul class="list-inline m-t-30 text-center font-12">
                            <li class="list-inline-item">
                                <i class="fa fa-circle text-success"></i> Công việc</li>
                            <li class="list-inline-item">
                                <i class="fa fa-circle text-info"></i> Dự án</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Thảo luận công việc</h4>
                    </div>
                    <div class="comment-widgets scrollable" style="height:560px;">
                        <!-- Comment Row -->
                        <div class="d-flex flex-row comment-row m-t-0">
                            <div class="p-2">
                                <img :src="images.userImage" alt="user" width="50" class="rounded-circle">
                            </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Nhóm chat gần đây nhất với bạn</h4>
